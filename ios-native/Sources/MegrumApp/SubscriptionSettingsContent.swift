...
struct SubscriptionSettingsContent: View {
    ...
    var body: some View {
        List {
            ...
            Section {
                ForEach(activeEntitlements) { entitlement in
    ...
    private var sortedPlans: [SubscriptionPlanDefinition] {
        SubscriptionCatalog.defaultPlans.sorted { $0.sortOrder < $1.sortOrder }
    }

    private var activeEntitlements: [UserEntitlement] {

            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    HomeMatchLogicHelpSection(
                        ...
                        actions: [
                            HomeMatchLogicHelpAction(title: "個別募集を作る", systemImage: "rectangle.stack.badge.plus", action: openIndividualListings)
                        ]
                    )
                    ...
                    HomeMatchLogicHelpSection(
                        ...
                        actions: [
                            HomeMatchLogicHelpAction(title: "Wishも設定", systemImage: "heart.fill", action: openWish)
                        ]
                    )
                    ...
                    HomeMatchLogicHelpSection(
                        ...
                        actions: [
                            HomeMatchLogicHelpAction(title: "個別募集を見直す", systemImage: "square.and.pencil", action: openIndividualListings)
                        ]
                    )
                    ...
                    HomeMatchLogicHelpSection(
                        ...
                        actions: [
                            HomeMatchLogicHelpAction(title: "交換条件を設定", systemImage: "slider.horizontal.3", action: openExchangeSettings),
                            HomeMatchLogicHelpAction(title: "支払条件を設定", systemImage: "yensign.circle", action: openPaymentSettings)
                        ]
                    )
                }

...
enum HomeDiscoveryFixtures {
    ...
    private static let fixtureGroupID = NativePreviewData.groupID
    private static let sanaMemberID = uuid("000000000a01")
    private static let momoMemberID = uuid("000000000a02")

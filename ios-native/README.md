...
- `Sources/MegrumData/SupabaseGroomClient.swift` contains the RPC request layer for `list_groom_feed_nearby`, Storage upload/signing, native groom post creation, groom views, and groom reactions.

...
|---|---|---|
| 有料機能 | メグルムプラス、Premium、めぐりPlus、ブーストの購入ボタン、復元ボタン、価格、特典説明、状態表示が画面に出ない | IAP商品、価格、復元、正式な公開特商法ページ、Purchases回答、購入開始/承認待ち/キャンセル/復元失敗/サーバー同期失敗のPrivacy反映、返金/取消/期限切れ同期、手動上書きの理由/期限/監査ログ/非保証説明 |

...
最終更新: 2026-07-06
ステータス: Draft v4.11（iter1226.336 ガイドツアー・ミッションカード・サンプル表示を反映）
...
| **ガイドツアー** | guide tour, オンボーディングツアー | 初期設定完了直後に初回のみ自動起動する使い方案内。全画面dim＋スポットライト＋吹き出しで、タップで進む7ステップ（ホーム3セクション→マイグッズ→ほしいもの→個別募集→やりとり→めぐり）。スキップ可。既読は端末ローカル（per-user UserDefaults）に保存し二度と自動表示しない。iOS標準TipKitでは実現不能なためカスタムオーバーレイ | iter1226.336 |

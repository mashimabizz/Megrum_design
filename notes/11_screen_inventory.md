...
| 画面ID | 名称 | 関連JSX関数 | 関連iter | 関連docs |
|---|---|---|---|---|
| `GUIDE-tour` | ガイドツアー（10章・約61ビート。登録/個別募集/打診の指実演デモ・タブ帯予告・戻るボタン・サンプル表示・ヘルプ＞使い方ガイドから章別再生可） | iter1226.336 で実装（モックアップ未） | iter1226.336, iter1226.337, iter1226.345, iter1226.352 | 10 §A ガイドツアー・使い方ガイド, 77 |
...
- v1.3 (2026-07-07, iter1226.345): GUIDE-tour をv3.1（10章・約50ビートの実演デモ）へ更新。
- v1.4 (2026-07-07, iter1226.352): GUIDE-tour をv3.3（約61ビート・戻るボタン・ヘルプ＞使い方ガイドの章別再生・ツアー中広告抑制）へ更新。

    ...
    <div style={{
      ...
      <div style={{ padding: '20px 18px 0' }}>
        <div style={{
          ...
          Megrum は <b>「全部公開」モデル</b>です。登録した在庫は全員に検索される前提でマッチングが動きます。譲りたくないものは登録しないか、「自分用キープ」として登録してください。
        </div>
    ...
    <div style={{
      ...
      <div style={{ padding: '32px 18px 0' }}>
        <div style={{
          ...
          <div style={{ fontSize: 22, fontWeight: 800, letterSpacing: 0.4 }}>Megrum</div>

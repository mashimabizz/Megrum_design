  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '20px 22px 0' }}>
        <LPInfoBox colors={c}>
          この利用規約（以下「本規約」）は、Megrum 運営者（以下「当社」）が提供するグッズ交換プラットフォーム「Megrum」（以下「本サービス」）の利用条件を定めるものです。本サービスをご利用の方（以下「利用者」）は、本規約に同意したうえでご利用ください。
        </LPInfoBox>
...
function PrivacyPolicy({ tweaks }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '20px 22px 0' }}>
        <LPInfoBox colors={c}>
          Megrum 運営者（以下「当社」）は、利用者の個人情報を尊重し、適切に取り扱うことを社会的責務と認識し、関連法令を遵守するとともに、本プライバシーポリシーに従って個人情報を取り扱います。
        </LPInfoBox>
        ...
        <LPArticle num="8" title="お問い合わせ窓口" colors={c}>
          ...
          <br/>
          <b style={{ color: c.ink }}>Megrum 個人情報保護管理者</b><br/>
          メール：support@megrum.jp<br/>
    ...
    <div style={{
      ...
      <div style={{ padding: '20px 22px 0' }}>
        ...
        <div style={{
          ...
          <LPDataRow colors={c} label="メールアドレス" value="support@megrum.jp" />
        ...
        <div style={{
          ...
          <LPDataRow colors={c} label="サービス名" value="Megrum（メグラム）" />
        ...
        <LPInfoBox colors={c} tone="warn">
          ...
          Megrumは利用者間の<b>物々交換（金銭授受を伴わない交換）</b>を仲介するプラットフォームです。当社は取引の当事者ではなく、利用者間の合意による交換を支援する立場です。利用者間で発生した取引に関する責任は、原則として当事者間で負うものとします。
        </LPInfoBox>
